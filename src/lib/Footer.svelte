...
<footer>
    <div class="container">
        ...
        <p>&copy; 2025 Festival Lowrider & Cultura Chicana. Todos os direitos reservados.</p>
    </div>
</footer>
...
<style>
    ...
    footer::before {
        ...
        opacity: 0.03;
        pointer-events: none;
        animation: hydraulic-side-to-side 15s ease-in-out infinite;
    }
    ...
    footer::after {
        ...
        font-size: 2em;
        opacity: 0.1;
        animation: lowrider-hop 8s ease-in-out infinite;
    }
    ...
    footer p {
        ...
        margin: 20px auto;
        max-width: 600px;
        border: 1px solid rgba(255, 217, 174, 0.3);
    }
